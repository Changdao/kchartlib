...
public class MainDraw implements IChartDraw<ICandle>{
    ...
    public MainDraw(BaseKChartView view) {
        ...
        mContext=context;
        Log.i("KCHARTLIB",""+ContextCompat.getColor(context,R.color.chart_red));
        Log.i("KCHARTLIB",""+ContextCompat.getColor(context,R.color.chart_green));
    ...
    private void drawSelector(BaseKChartView view, Canvas canvas) {
        ...
        strings.add(view.getAdapter().getDateString(index));
